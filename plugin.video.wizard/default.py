...
def CATEGORIES():
    link = OPEN_URL('https://raw.githubusercontent.com/joelgrace1/repository.livetv/master/wizard2.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("TV Direto Wizard","Downloading ",'', 'Please Wait')
